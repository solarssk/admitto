...
**Font formats (`apps/admin`): woff2 only, no woff/truetype fallback** — the app's JS already
requires a browser new enough that woff2 is a given, so older formats are pure dead weight. See
