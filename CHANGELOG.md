...
- Settings → Archiving no longer silently drops the connection-state banner when the events list fails to load - a 401/403/5xx now flags the same shared connection-state indicator every other events-list screen already reports through.
