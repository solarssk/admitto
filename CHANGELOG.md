...
### Fixed
- Concurrent OIDC instance-superadmin revokes no longer thrash under Serializable isolation: retry backoff uses full jitter (and more attempts) so CI no longer flakes on `P2034` / write conflicts.
