...
- Event settings → Wallet's "Wallet push history" list now shows a Scope column (how many attendees, or the whole event plus which location/settings save triggered it) and supports pagination instead of always showing only the most recent rows.
