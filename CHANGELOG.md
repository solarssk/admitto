...
- Check-in: manual lookup no longer misfires as a QR scan mid-typing for queries over 20 characters — wedge auto-submit now requires burst-speed keystrokes (hardware scanner), not just buffer length (#262).
