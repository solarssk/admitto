...
- Attendees' Wallet column and the attendee-detail Wallet card rendered the Samsung Wallet icon visibly smaller than its Apple/Google neighbors despite sharing the same font-size, because the SVG kept a large margin of transparent space around the mark inside its own box. The icon is now cropped to the mark's real bounds, matching the visual size of the two Tabler glyphs beside it.
