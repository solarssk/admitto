...
- Reports has a new "Wallets" tab: wallet adoption and platform-mix breakdowns, adoption by ticket type, cumulative passes issued, time from ticket email to wallet install, and check-in rate compared between attendees with and without a wallet pass.
