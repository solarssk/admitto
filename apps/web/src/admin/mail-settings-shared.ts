 ...
 * (missing provider, blocked/unresolvable SMTP or webhook host, undecryptable stored
 * secret) to 422 JSON. Returns null for unrelated errors so the caller can rethrow.
 */
