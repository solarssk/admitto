...
describe("AttendeesPage mail delivery status filter (#522)", () => {
  it("changing the mail status filter re-fetches with mail_status and resets to page 1", async () => {
    ...
    // Move off page 1 first, so we can prove the filter change resets it.
