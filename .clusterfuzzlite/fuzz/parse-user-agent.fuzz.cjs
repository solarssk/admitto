// Fuzzes packages/shared/src/parseUserAgent.ts's parseUserAgent/parseUserAgentWithVersion -
...
const { parseUserAgent, parseUserAgentWithVersion } = require("../.build/shared/parseUserAgent.cjs");
