...
Only the **latest minor release** is supported (currently `0.5.x`, latest <!-- admitto:latest-patch -->`0.5.3`<!-- /admitto:latest-patch -->). Deploy from signed
semver tags (`v0.5.y`) published to `ghcr.io/solarssk/admitto`.
