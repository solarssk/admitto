...
Only the **latest minor release** is supported (currently `0.6.x`, latest <!-- admitto:latest-patch -->`0.6.1`<!-- /admitto:latest-patch -->). Deploy from signed
semver tags (`v0.6.y`) published to `ghcr.io/solarssk/admitto`.
