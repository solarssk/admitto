...
export const SETTING_DEFAULTS = new Map<string, unknown>([
  ...
  [SETTING_OPERATOR_REMEMBER_ME_DAYS, DEFAULT_OPERATOR_REMEMBER_ME_DAYS],
  ...
  [SETTING_PASSKEY_LOGIN_ENABLED, false],
  [SETTING_PASSKEY_CONDITIONAL_UI_ENABLED, false],
  [SETTING_CSP_TRUSTED_ORIGINS, []],
]);
...
export const SETTING_ENV_LOCKS = new Map<string, string>([
  ...
  [SETTING_OPERATOR_REMEMBER_ME_DAYS, "OPERATOR_REMEMBER_ME_DAYS"],
