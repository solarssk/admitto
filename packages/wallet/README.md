...
This README is the current technical reference. Internal design docs record *why* these decisions
were made and the live-verification history behind them - read this file for *what is true
today*, those for the reasoning trail.
