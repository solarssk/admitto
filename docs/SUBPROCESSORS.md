...
| **CI / dev tooling (repository only)** | Codecov (coverage uploads), GitHub Actions | Test coverage reports from CI (LCOV — source paths and hit counts, no production attendee DB) | When using project CI; not part of customer production stack |
