...
8. Switch to the **Wallets** tab for wallet-adoption analytics: pass adoption and platform mix (Apple/Google), how many devices or accounts each attendee's pass is actively registered on, adoption by ticket type, cumulative passes issued over time, how long it takes attendees to actually get their pass confirmed installed after the ticket email, and check-in rate compared between attendees with and without a wallet pass.
