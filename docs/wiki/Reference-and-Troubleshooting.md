...
- **Deprecated** means still visible but planned for removal.

## Help

For task-based diagnosis, start with [Help and Troubleshooting](Help-and-Troubleshooting). For deployment, security, privacy, architecture, or contributor guidance, use [Technical Documentation](Technical-Documentation).
