...
5. Use **Security logs** for durable sign-in, MFA, OIDC, logout, and access-denied events retained in the database (default **30 days**, `SECURITY_AUDIT_LOG_RETENTION_DAYS`).
