...
- **The Wallet badge does not open a pass when tested:** Apple and Google Wallet links are planned and currently render empty; see [Template Variables](Template-Variables).
