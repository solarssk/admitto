...
**Audience:** Event Managers and Superadmins · **Required role:** Administrator or Superadmin · **Feature status:** ✅ Available · **Last verified:** Admitto 0.6.4
...
- **Resend** and **Dismiss bounce** appear only on a Bounced row, and both grey out on that row once used, since a delivery row's recorded status does not change afterward.
