...
**Audience:** All staff · **Required role:** Any staff role · **Feature status:** ✅ Available · **Last verified:** Admitto 0.6.0
...
| Passkey | A second factor registered under My account (for example Face ID, Windows Hello, or one saved to a password manager/iCloud Keychain and synced across your devices), usable to sign in and to confirm sensitive account actions the same way an authenticator app code can. |
