...
- [3. Business flow](#3-business-flow)
  - [3.1 Triggers, actions, and processes](#31-triggers-actions-and-processes)
- [4. Exposure overview (generic)](#4-exposure-overview-generic)
- [5. Data categories (summary)](#5-data-categories-summary)
- [6. Security and privacy documentation map](#6-security-and-privacy-documentation-map)
- [7. If your reviewer uses a formal framework or questionnaire](#7-if-your-reviewer-uses-a-formal-framework-or-questionnaire)
- [8. Conscious exclusions (MVP)](#8-conscious-exclusions-mvp)
- [9. Evidence artefacts (repository)](#9-evidence-artefacts-repository)
...
- **A technical/code-level review (pentest scoping, secure-SDLC checklist):** use the
  ...
  what [SECURITY-CONTROLS.md](SECURITY-CONTROLS.md) already documents (authentication,
